...
<div class="">
  ...
  <div class="row">
    ...
    <br>
    <br>
      <center>  <img src="image/hpp1.jpg" class="img-responsive" width="450" height="350"></center>
    </div>
    
      <div class="col-md-6 col-xs-6 col-lg-6">
        <div class="row" class=" border border-success">
            <h1 class="border">HP for Domestic purpose 19 Kg LPG Gas Cylinder
   ...
   <div class="row">
        ...
        <br>
         ...
         <center> <img src="image/hpbluecylinder.jpg" class="img-rounded" class="img-responsive"  width="350" height="450"></center>
        </div>
       <div class="col-md-6 col-xs-6">
        <div class="row" class=" border border-success">
            <h1 class="border">HP for Commercial purpose 19 Kg LPG Gas Cylinder
  ...
  <span class="border border-info">
    <div class="row">
      ...
      <br>
      <br>
       <center><img src="image/hp5kg2.jpg" class="img-responsive" backgroundcolour="yellow" width="250" height="350"></center>
      </div>
      <div class="col-md-6 col-xs-6">       
       <div class="row" class=" border border-success">
            <h1 class="border">HP for Domestic purpose 5 Kg LPG Gas Cylinder
