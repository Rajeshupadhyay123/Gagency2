...
<%
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/minor_project3","root","prince@123");
    PreparedStatement st=con.prepareStatement("select firstname,lastname,mobile,address,aadhaarNum,password,age,counum from registration where email=?");
    ...
    String counum=rs.getString(8);
    String aadhaarNum=rs.getString(5);
								...
								<tr>
									<td class="td_css">NAME</td>
                                      ...
                                      <%
                                      	...
                                      	String url="Editing.jsp?firstname="+firstname+"&lastname="+lastname+"&email="+""+"&contact="+""+"&address="+""+"&password="+""+"&age="+""+"&counum="+"";
								...
								<tr>
									...
									<td class="td_bold"><%=age %></td>
									 <%
                                      	...
                                      	String url7="Editing.jsp?firstname="+""+"&lastname="+""+"&email="+""+"&contact="+""+"&address="+""+"&password="+""+"&age="+age+"&counum="+"";
                                      
                                      %> 
									<td><a href=<%=url7 %>><span class="glyphicon glyphicon-chevron-right"></span></a></td>
								</tr>
								<tr>
									<td class="td_css">Coupon Number</td>
									<td class="td_bold"><%=counum %></td>
									<%
                                     
                                      	String url2="Editing.jsp?firstname="+""+"&lastname="+""+"&email="+""+"&contact="+""+"&address="+""+"&password="+""+"&age="+""+"&counum="+counum;
									...
									<%
                                      	...
                                      	String url3="Editing.jsp?firstname="+""+"&lastname="+""+"&email="+""+"&contact="+""+"&address="+""+"&password="+newPass+"&age="+""+"&counum="+"";
							...
							<tbody>
								<tr>
									...
									<%
                                      	...
                                      	String url4="Editing.jsp?firstname="+""+"&lastname="+""+"&email="+email+"&contact="+""+"&address="+""+"&password="+""+"&age="+""+"&counum="+"";
								...
								<tr>
									...
									<%
                                      	...
                                      	String url5="Editing.jsp?firstname="+""+"&lastname="+""+"&email="+""+"&contact="+mobile+"&address="+""+"&password="+""+"&age="+""+"&counum="+"";
                                      
                                      %>
									<td><a href=<%=url5 %>><span class="glyphicon glyphicon-chevron-right"></span></a></td>
								</tr>
								<tr>
									<td class="td_css">ADDRESS</td>
									<td class="td_bold"><%=address%></td>
									<%
                                      
                                      	String url6="Editing.jsp?firstname="+""+"&lastname="+""+"&email="+""+"&contact="+""+"&address="+address+"&password="+""+"&age="+""+"&imgPath="+"";
