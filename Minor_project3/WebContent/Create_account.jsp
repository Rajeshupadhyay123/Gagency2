    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                  ...
                  <form class="form" action="UserVerification.jsp" method="post" id="registrationForm" onsubmit="return validation()">
          ...
          <br>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="phone"><h4>Coupan Number</h4></label>
                              <input type="text" class="form-control" name="counum" id="phone" placeholder="enter coupan number" title="enter your phone number if any.">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="address" id="location" placeholder="Enter your parmanent Address" title="enter a location">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="email"><h4>Aadhaar Number</h4></label>
                              <input type="text" class="form-control" name="aadhaarNum" id="email" placeholder="Enter your aadhaar number" title="enter your aadhaar number.">
                              <span id="location" class="text-danger font-weight-bold"> </span>
                          </div>
                      </div>
                      <br>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="age" id="location" placeholder="Enter your Age" title="enter your age">
                              <span id="location" class="text-danger font-weight-bold"> </span>
                          </div>
                      </div>
                      <br>
