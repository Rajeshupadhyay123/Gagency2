...
<div class="">
  ...
  <div class="row">
    ...
    <br>
    <br>
      <center>  <img src="image/indian19kg.jpg" class="img-responsive" width="500" height="400"></center>
    </div>
    
      <div class="col-md-6 col-xs-6 col-lg-6">
        <div class="row" class=" border border-success">
            <h1 class="border">Indane for Domestic purpose 19 Kg LPG Gas Cylinder
   ...
   <div class="row">
        ...
        <br>
        <br>
         <center> <img src="image/indian19kgblue.jpeg" class="img-rounded" class="img-responsive"  width="250" height="450"></center>
        </div>
       <div class="col-md-6 col-xs-6">
        <div class="row" class=" border border-success">
            <h1 class="border">Indane for Commercial purpose 19 Kg LPG Gas Cylinder
  ...
  <span class="border border-info">
    <div class="row">
      ...
      <center><img src="image/indian5kg.png" class="img-responsive" backgroundcolour="yellow" width="700" height="550"></center>
      </div>
      <div class="col-md-6 col-xs-6">       
       <div class="row" class=" border border-success">
            <h1 class="border">Indane for Domestic purpose 5 Kg LPG Gas Cylinder
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
        	...
        	<form action="bookVali_indian.jsp">
